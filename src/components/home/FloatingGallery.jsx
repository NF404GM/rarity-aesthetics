...
const GlassCard = ({ service, index }) => {
    ...
    return (
        <motion.div
            ...
            className={`relative w-full md:w-[80vw] mx-auto mb-16 md:mb-32 ${index % 2 === 0 ? 'md:ml-0' : 'md:ml-auto md:mr-0'} md:max-w-5xl`}
        >
            <motion.div
                animate={{
                    y: [0, -20, 0],
                ...
                className="group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-[3rem] overflow-hidden shadow-2xl transition-all duration-500 hover:shadow-[0_0_50px_rgba(212,175,55,0.15)]"
            >
                ...
                <div className="flex flex-col md:flex-row h-full">
                    ...
                    {/* Content Half */}
                    <div className="w-full md:w-1/2 p-6 md:p-10 lg:p-16 flex flex-col justify-center relative bg-gradient-to-b from-transparent to-rarity-ink/40">
                        ...
                        <h3 className="font-playfair text-3xl md:text-5xl lg:text-6xl text-white mb-6 md:mb-8 italic leading-none">
                            {service.title}
                        </h3>
...
const FloatingGallery = () => {
    return (
        <section className="relative py-16 md:py-32 px-4 md:px-6 overflow-hidden bg-rarity-ink">
